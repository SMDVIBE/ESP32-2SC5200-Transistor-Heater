...
The heater uses the 2SC5200 transistor's VBE as a temperature-dependent signal.
...
- `TEMP_OFFSET_C` corrects the low-temperature offset.
...
Different transistors may require different calibration values.
